 ...
 *
 * @author Michael Zhou
 * @version $Id: StringUtil.java,v 1.3 2010-08-16 02:29:36 zhaoyanming Exp $
 */
public class StringUtil {
	...
	/**
	 * ********************************************
	 * method name   : formatMobile 
	 * description   : 手机号码格式化(NNN NNNN NNNN) 
	 * @return       : String
	 * @param        : @param mobileid
	 * @param        : @return
	 * modified      : hejinyun@umpay.com ,  2015-10-30  下午2:06:03
	 * @see          : 
	 * *******************************************
	 */
	public static String formatMobile(String mobileid){
		if ((null == mobileid)){
			return "";
		}
		StringBuffer buffer = new StringBuffer();
		buffer.append(mobileid.substring(0, 3));
		buffer.append("  ");	
		buffer.append(mobileid.substring(3, 7));
		buffer.append("  ");
		buffer.append(mobileid.substring(7));
		return buffer.toString();
	}
	
	/**
	 * ********************************************
	 * method name   : hideMobile 
	 * description   : 隐藏手机号中间4位,如139****4175
	 * @return       : String
	 * @param        : @param mobileid
	 * @param        : @return
	 * modified      : xuhuafeng ,  2017-4-13  下午9:00:42
	 * *******************************************
	 */
	public static String hideMobile(String mobileid){
		if ((null == mobileid)){
			return "";
		}
		StringBuffer buffer = new StringBuffer();
